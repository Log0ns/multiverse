    ...
    function applySplit(on) {
      if (on && window.innerWidth > 768) {
        ...
        function renderSplitBible() {
          ...
          let bhtml = '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">';
          ...
          bhtml += '</div>';
          // Note buttons for this chapter
          const chNotes = Store.getNotesForChapter(chKey);
          if (chNotes.length > 0) {
            bhtml += '<div style="display:flex;flex-wrap:wrap;gap:4px;margin-bottom:6px;padding-bottom:6px;border-bottom:1px solid #374151;">';
            for (const cn of chNotes) {
