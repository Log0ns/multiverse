...
function updateBiblePanel() {
  ...
  let html = '<div class="dp-header"><h3 style="margin:0;">' + selectedBook + " " + ch + '</h3><span class="dp-toggle">&#9660;</span></div>';
  ...
  detailPanel.querySelector(".dp-header").addEventListener("click", () => {
