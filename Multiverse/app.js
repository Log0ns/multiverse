...
function updateBiblePanel() {
  ...
  let html = '<div class="dp-header"><button class="dp-nav dp-prev">&#9664;</button><h3 style="margin:0;flex:1;text-align:center;">' + selectedBook + " " + ch + '</h3><button class="dp-nav dp-next">&#9654;</button><button class="dp-nav dp-mem-tab" title="Memorize">&#9733;</button><button class="dp-nav dp-split-open" title="Split View">&#9871;</button><span class="dp-toggle">&#9660;</span></div>';
  ...
  detailPanel.querySelector(".dp-split-open").addEventListener("click", () => {
