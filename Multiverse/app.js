...
function showEditPanel(id) {
  document.getElementById("note-preview-popup").style.display = "none";
...
function handleNodeLongPress(node, sx, sy) {
  ...
  popup.querySelector(".npp-close").addEventListener("click", () => { popup.style.display = "none"; });
}

function handleNodeClick(node, wasSelected) {
  if (!node) { graphAddNoteBtn.style.display = "none"; graphAddNoteNode = null; document.getElementById("note-preview-popup").style.display = "none"; previewPopupNode = null; return; }
